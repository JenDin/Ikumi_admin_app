      ...
      <div class="max-w-md mx-auto">
        <div class="flex items-center space-x-5">
          <div class="block font-semibold text-xl self-start text-gray-700">
            <!-- Change the text inside the form based on if the user adds or updates a product -->
        ...
        <div class="divide-y divide-gray-200">
          ...
          >
            ...
            <div class="flex flex-col">
              ...
              <select
                id="category"
                class="text-sm py-1.5 border bg-white border-gray-300 rounded-md focus:border-gray-900 text-gray-600 focus:outline-none"
                v-model="category"
              >
                <!-- Make this the default value at the start -->
                <option disabled value="">Choose a category</option>
                <!-- Loop through each color in the database -->
